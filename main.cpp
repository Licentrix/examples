...
int main() {
	...
	const std::string& pathToSaveTheRequest = licenseConf["Licensing"]["FilePath"];
	...
	const LLKStatus activateLicenseStatus = llkOfflineActivationRequest(inputJSON.dump().c_str());
